...
export default function ContactForm() {
  ...
  const handleSubmit = (event) => {
    ...
    gsap.timeline({ onComplete: () => setSuccess(true) })
      .to(button, { scaleX: 0.3, borderRadius: '50%', duration: 0.35, ease: 'power3.inOut' })
      .to(button, { scaleX: 1, width: 56, color: '#060606', background: '#f5f5f5', duration: 0.35, ease: 'expo.out' })
  ...
  return (
    <section className="contact-form-section shell section-pad">
      ...
      <form className="contact-form" onSubmit={handleSubmit} noValidate>
        ...
        <div className="contact-form__submit">
          ...
          {success && <p role="status">Mensagem pronta. Obrigado — falo com você em breve.</p>}
        </div>
      </form>
    </section>
  )
