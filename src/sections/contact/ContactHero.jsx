  ...
  return (
    <header ref={rootRef} className="contact-hero">
      ...
      <div className="contact-hero__content shell">
        <p className="eyebrow"><span /> Tem uma ideia?</p>
        <h1 ref={titleRef}>Vamos trabalhar <em>juntos?</em></h1>
        <p>Conte um pouco sobre o projeto. Eu respondo com perguntas boas, possibilidades claras e um próximo passo.</p>
      </div>
    </header>
  )
}
