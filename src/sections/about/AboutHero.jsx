  ...
  return (
    <header ref={rootRef} className="about-hero">
      ...
      <div className="about-hero__content shell">
        <p className="eyebrow"><span /> Criador · Estrategista · Desenvolvedor</p>
        <h1 ref={titleRef}>Olá, eu sou <em>Ruan.</em></h1>
        <p className="about-hero__intro">Crio pontes entre boas ideias e as pessoas certas.</p>
      </div>
    </header>
  )
}
